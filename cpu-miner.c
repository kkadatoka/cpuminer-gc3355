...
static void *tui_main_thread(void *userdata)
{
	...
	while(opt_curses)
	{
		...
		for(i = 0; i < opt_n_threads; i++)
		{
			...
			{
				applog(LOG_DEBUG,"GSD %d - Detail: C0(%d MHz): A %d:R %d:H %d, C1(%d MHz): A %d:R %d:H %d, C2(%d MHz): A %d:R %d:H %d, C3(%d MHz): A %d:R %d:H %d, C4(%d MHz): A %d:R %d:H %d", i, gc3355_devs[i].freq[0], gc3355_devs[i].accepted[0], gc3355_devs[i].rejected[0], gc3355_devs[i].hwe[0], gc3355_devs[i].freq[1], gc3355_devs[i].accepted[1], gc3355_devs[i].rejected[1], gc3355_devs[i].hwe[1], gc3355_devs[i].freq[2], gc3355_devs[i].accepted[2], gc3355_devs[i].rejected[2], gc3355_devs[i].hwe[2], gc3355_devs[i].freq[3], gc3355_devs[i].accepted[3], gc3355_devs[i].rejected[3], gc3355_devs[i].hwe[3], gc3355_devs[i].freq[4], gc3355_devs[i].accepted[4], gc3355_devs[i].rejected[4], gc3355_devs[i].hwe[4]);
				window_lines_addstr(wl, i, " | Detail: C0(%d MHz): A %d:R %d:H %d, C1(%d MHz): A %d:R %d:H %d, C2(%d MHz): A %d:R %d:H %d, C3(%d MHz): A %d:R %d:H %d, C4(%d MHz): A %d:R %d:H %d", gc3355_devs[i].freq[0], gc3355_devs[i].accepted[0], gc3355_devs[i].rejected[0], gc3355_devs[i].hwe[0], gc3355_devs[i].freq[1], gc3355_devs[i].accepted[1], gc3355_devs[i].rejected[1], gc3355_devs[i].hwe[1], gc3355_devs[i].freq[2], gc3355_devs[i].accepted[2], gc3355_devs[i].rejected[2], gc3355_devs[i].hwe[2], gc3355_devs[i].freq[3], gc3355_devs[i].accepted[3], gc3355_devs[i].rejected[3], gc3355_devs[i].hwe[3], gc3355_devs[i].freq[4], gc3355_devs[i].accepted[4], gc3355_devs[i].rejected[4], gc3355_devs[i].hwe[4]);
			}
		}
